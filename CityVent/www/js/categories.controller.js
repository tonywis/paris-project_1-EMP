angular.module('app')
.controller('categoriesController', function(QueFaireService, locationService,$ionicGesture,$scope, $ionicPlatform,dataService,$state,$http,$q){
	var cV = this;
	var gettyimageKey = "q5huf6j8bg8qt3jnmxd536v7";
	cV.request = dataService.request;
	 var element = angular.element(document.querySelector('.card')); 
/*$scope.$watch(cV.pressing, function() {
	 cV.pressing =false;
	$ionicGesture.on('hold',function(e){
		//$scope.$apply(cV.pressing, function() {
		...
		//console.log(cV.pressing);
console.log($ionicGesture.on);*/
$scope.pressing=false;
$scope.$watch('pressing', function() {
